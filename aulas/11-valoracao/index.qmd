...
::: {.no-bullet}
[É o Teorema de Coase: a dotação inicial de direitos muda quem paga, não a alocação.]{.fragment fragment-index=1}
:::
...
- Suponha um aumento de preço → A variação compensada é a quantidade de dinheiro
  que o **consumidor precisa receber para alcançar a utilidade anterior ao aumento de preço.**
- Suponha uma queda de preço → A variação compensada é a quantidade de dinheiro
  que o **consumidor precisa perder para alcançar a utilidade anterior à queda de preço.**
...
::: {.diagram}
![](../_assets/figuras/11-vc.svg){style="height:300px;max-height:300px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-ve.svg){style="height:300px;max-height:300px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-area-vc.svg){style="height:340px;max-height:340px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-area-ve.svg){style="height:340px;max-height:340px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-area-ec.svg){style="height:340px;max-height:340px"}
:::
...
## Quando usar excedente do consumidor? {.smaller}
...
- Com a mesma queda de preço, o erro é pequeno quando o bem pesa pouco no
  orçamento.
- Para casos em que **bem ambiental represente fatia pequena do orçamento**, a aproximação
  Marshalliana pode servir **se houver bens substitutos**.
...
::: {.diagram}
![](../_assets/figuras/11-area-q.svg){style="height:295px;max-height:295px"}
:::

- Mesmo consumidor, mesma renda, preço fixo em ${p}^{0}=4$. Suponha que $q$ duplique,
  levando a utilidade de 25 a 50, como no exemplo do preço.
...
- Além disso, $q$ não é escolhido pelo consumidor, pois é bem público: não há demanda por $q$ a ser
  traçada, nem excedente do consumidor a calcular.
- No exemplo anterior, a demanda por viagens fica em 12,5 antes e depois. O
  consumidor ficou duas vezes melhor, mas não há mercado evidenciando essa mudança.
...
::: {.diagram}
![](../_assets/figuras/11-choke-1.svg){style="height:300px;max-height:300px"}
:::

- A viagem custa R\$ 20, e consumidor faz 4 viagens por ano.
- Acima de R\$ 60, não vai mais: este é o preço de esgotamento
  $\overline{p}({q}^{0})$.

## Com a praia limpa

::: {.diagram}
![](../_assets/figuras/11-choke-2.svg){style="height:300px;max-height:300px"}
:::
...
- Note que nenhuma das duas curvas mostra o preço do bem ambiental. A
...
- Isso é o que chamamos conceitualmente de **complementaridade fraca** [@maler1974].
...
## O que a viagem não mede? {.smaller}

::: {.diagram}
![](../_assets/figuras/11-nao-uso.svg){style="height:360px;max-height:360px"}
:::
...
::: {.no-bullet}
O vazamento da plataforma Deepwater Horizon, em 2010, contaminou a costa do Golfo do México. Para calcular a indenização, a agência ambiental americana usou algo parecido com o que vimos agora [@english2018].
:::
...
- Note o que **não** está nesses 661 milhões: o valor que alguém em Chicago
  atribui a um Golfo do México limpo sem nunca pensar em visitar a região.
...
- No mesmo processo, uma pesquisa de preferência **declarada** perguntou a
  ...
  [@bishop2017]. A conta alcançou **US\$ 17,2 bilhões**.
...
::: {.diagram}
![](../_assets/figuras/11-substitutos.svg){style="height:295px;max-height:295px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-mwtp.svg){style="height:295px;max-height:295px"}
:::
...
::: {.diagram}
![](../_assets/figuras/11-exercicio.svg){style="max-height:285px"}
:::
